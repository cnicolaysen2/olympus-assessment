...
export class StackedBarChartComponent implements OnInit {
  @ViewChild("containerStackedBarChart") element: ElementRef;
  ...
  ngOnInit() {
    ...
    var initStackedBarChart = {
      draw: (config) => {
        var me = this,
            ...
            svg = d3.select(this.element.nativeElement).append("svg")
        ...
        layer.selectAll("rect")
            ...
            .enter().append("rect")
            .attr("y", function (d) {
              return yScale(<any>parseDate(<any>d.data.date));
            })
            .attr("x", function (d) {
              return xScale(d[0]);
            })
    ...
    var data = [{"date": "4/1854", "total": 8571, "disease": 1, "wounds": 0, "other": 5}, {
      "date": "5/1854",
      "total": 23333,
      "disease": 12,
      "wounds": 0,
